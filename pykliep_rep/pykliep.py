...
class DensityRatioEstimator:
    ...
    def __init__(self, max_iter=5000, num_params=[.1,.2], epsilon=1e-4, cv=7, sigmas=[.01,.1,.25,.5,.75,1], random_state=None, verbose=0):
        """
    ...
    def fit(self, X_train, X_test, alpha_0=None):
        ...
        np.random.permutation(X_test_shuffled)
